...
NSString * const JTTDefaultTriggerString = @"bbb";

NSString * const JTTDefaultLabelTriggerString = @"lll";

NSString * const JTTDefaultTableviewTriggerString = @"ttt";
...
{
    return JTTDefaultLabelTriggerString;
}

- (NSString *)triggerTableviewString
{
    return JTTDefaultTableviewTriggerString;
}

- (NSDictionary *)triggerCustomStringDict
{
    NSDictionary *cutomKeyDict = [[NSUserDefaults standardUserDefaults] objectForKey:@"autogeneratecode"];
    return cutomKeyDict;
}
